# Random Forest Model- Combine filtered metadata and filtered DESeq taxa
...
ggsave("ROC_Plot_DESeq_taxa_clinical_combined.png", roc_plot, width = 8, height = 6, dpi = 300)
